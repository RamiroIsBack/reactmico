...
import {
  ...
  AsyncCarro,
  AsyncAmigo,
  AsyncAmigoPedidosContainer,
  AsyncAmigoDatosContainer
} from "./components/AsyncComponentsReady";

class ReactMico extends Component {
  render() {
    let ready = true;
    let picConstruccion =
      "https://firebasestorage.googleapis.com/v0/b/micotextil-3f024.appspot.com/o/micEnConstruccion-mobile2.png?alt=media&token=4cba7d9f-8a8f-4cad-a379-1dbabcbfea0a";
              ...
              >
                <div className="main__container visible-xs-block hidden-sm hidden-md hidden-lg">
                  ...
                  <div className="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <h5>
                      Dentro de muy poco tendrás una guía con todas las ferias
                      para que puedas ir a verme y una tienda online donde
                      podrás comprar mis productos desde casa si lo prefieres{" "}
                    </h5>
                    <br />

                    <h5>
                      hasta entonces, sígueme en las redes sociales o contacta
