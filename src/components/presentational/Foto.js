      ...
      <div  style= {{maxWidth: 300, minHeight: 175, padding: 5 ,}}>
        ...
        {!this.props.creacion.vendido && !this.props.creacion.precioRebajado &&
          <div  style= {{position: 'relative', top: 0, left: 0}}>
            ...
            <img src= {url} className="img-responsive img-rounded" alt={nombre} style= {{maxWidth:'100%', maxHeight : '200px',opacity:1 , position: 'relative', top: 0, left: 0,cursor: 'pointer'}}
            ...
            <h6  style = {{top:0,left:0,position:'absolute' ,opacity:0.5, padding: '0px', overflow: 'hidden', margin:0}}>{numPic}</h6>
          </div>
        }
        ...
        <div className = 'row' style= {style.foto.container}>
          ...
          {this.props.creacion.precioRebajado&&
            <div className = 'container col-xs-3 col-sm-3 col-md-3 col-lg-3' style = {{paddingLeft :5, paddingRight: 5,textAlign:'center'}}>
              <h6 className = 'text-muted ' style={{textDecoration: 'line-through',marginBottom:'1px'}}>{precio}€</h6>
              <h5 className = 'text-muted ' style={{marginTop:'1px'}}>{this.props.creacion.precioRebajado}€</h5>
            </div>
          }
        </div>
      </div>
