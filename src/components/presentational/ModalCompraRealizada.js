...
class ModalCompraRealizada extends React.Component {
  ...
  render() {
    ...
    if (this.props.carroPedido.cartList) {
      carroLista = this.props.carroPedido.cartList.map((productInCart, i) => {
        return (
          <div
            key={i}
            style={{
    ...
    let progressI =
      "https://firebasestorage.googleapis.com/v0/b/micotextil-3f024.appspot.com/o/proceso%20de%20compra3.png?alt=media&token=5f94f2f9-6a09-4439-8fa6-1110a973b1ad";
          ...
          <div>
            ...
            >
              ...
              >
                ...
                <button
                  id="datosEnvio"
                  onClick={this.irAPedidos.bind(this)}
                  style={{
                    cursor: "pointer",
                    border: "none",
                    borderRadius: 4,
              ...
              <div>
                <div
                  className="hidden-xs col-sm-6 col-md-4  col-lg-4 "
                ...
                >
                  ...
                  <p style={{ marginBottom: 1 }}>
                    {" "}
                    {
                      this.props.pagoPedido.envioDefinitivo.nombreCompletoEnvio
                    }{" "}
                  </p>
                  <p style={{ marginBottom: 1 }}>
                    {" "}
                    {this.props.pagoPedido.envioDefinitivo.calle}{" "}
                  </p>
                  <p style={{ marginBottom: 1 }}>
                    {" "}
                    {this.props.pagoPedido.envioDefinitivo.localidad}{" "}
                  </p>
                  <p style={{ marginBottom: 1 }}>
                    {" "}
                    {this.props.pagoPedido.envioDefinitivo.cp +
                      " , " +
                      this.props.pagoPedido.envioDefinitivo.provincia}{" "}
                  </p>
                </div>

                <div
                  className="hidden-sm hidden-md hidden-lg visible-xs-block col-xs-12"
                  style={{ paddingLeft: 0, paddingRight: 0, paddingBottom: 5 }}
                >
                  <h4>el pedido se enviará a la siguiente direncción:</h4>
                  <hr style={{ padding: 0, marginTop: 0, marginBottom: 2 }} />
                  <p style={{ marginBottom: 1 }}>
