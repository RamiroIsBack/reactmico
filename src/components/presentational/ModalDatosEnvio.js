...
class ModalDatosEnvio extends React.Component {
  ...
  render() {
    ...
    const carroLista = this.props.carro.cartList.map((productInCart, i) => {
      return (
        <div
          key={i}
          style={{
    ...
    let progressI =
      "https://firebasestorage.googleapis.com/v0/b/micotextil-3f024.appspot.com/o/proceso%20de%20compra1.png?alt=media&token=75d910d4-75eb-4ce4-8d00-934acce712b3";
            ...
            >
              <div style={{ minHeight: 122 }}>
                <img
                  id="foto"
                  src={progressI}
                  alt="imagen de progreso de compra"
              ...
              >
                ...
                <button
                  id="datosEnvio"
                  onClick={this.irAformaDePago.bind(this)}
                  style={{
                    cursor: "pointer",
                    border: "none",
                    borderRadius: 4,
                ...
                <div>
                  ...
                  >
                    ...
                    <button
                      ...
                      id="datosEnvio"
                      onClick={this.corregirDatos.bind(this)}
                      style={{
                        cursor: "pointer",
                        border: "1px solid",
                        borderRadius: 4,
              ...
              >
                ...
                <button
                  className="btn text-center form-control "
                  id="datosEnvio"
                  onClick={this.cambiarCarro.bind(this)}
                  style={{
                    cursor: "pointer",
                    border: "1px solid",
                    borderRadius: 4,
