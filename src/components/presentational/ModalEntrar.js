...
class ModalEntrar extends React.Component {
  ...
  render() {
    ...
    var loginMIcon =
      "https://firebasestorage.googleapis.com/v0/b/micotextil-3f024.appspot.com/o/login%20with%20password.png?alt=media&token=8b2ec7a9-c286-4c65-b720-93ed6aec4ab7";
    return (
            ...
            >
              ...
              {this.state.entrarG && (
                <div className="container-fluid row">
                  <div className="container-fluid row visible-xs-block hidden-sm hidden-md hidden-lg">
                    <h6 className="text-center" style={{ fontWeight: "bold" }}>
                      Estamos gestionando el registro con google
                    </h6>
                  </div>
                  <div className="container-fluid row hidden-xs">
                    ...
                    <h6 className="text-center">
                      tiene que aparecer una ventana emergente [pop up], si no
                      aparece, puede que lo tengas deshabilitado en tu navegador
                    </h6>
                  </div>
                </div>
              )}
              {this.state.entrarF && (
                <div className="container-fluid row">
                  <div className="container-fluid row visible-xs-block hidden-sm hidden-md hidden-lg">
                    <h6 className="text-center" style={{ fontWeight: "bold" }}>
                      Estamos gestionando el registro con Facebook
                    </h6>
                    <h6 className="text-center">
                      tiene que aparecer una ventana emergente [pop up], si no
                      aparece, puede que lo tengas deshabilitado en tu navegador
              ...
              {this.state.entrarM && (
                <div className="container-fluid">
                  <div className="container-fluid row">
                    ...
                    <div className="form-group row">
                      <button
                        onClick={this.handleEntrar.bind(this)}
                  ...
                  <div className="container-fluid row">
                    <div className="container-fluid row visible-xs-block hidden-sm hidden-md hidden-lg">
                      <hr
                        style={{ padding: 0, marginTop: 0, marginBottom: 2 }}
                      />
                    </div>
                    <div className="container-fluid row hidden-xs">
                      <hr />
              ...
              <div className="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                Si todavia no tientes cuenta con nosotros, hazte una con tu
                email:
              </div>
              <div className="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                <button
