...
class Contacto extends Component {
  ...
  render() {
    ...
    if (this.props.contactoContenido.descripcion) {
      descripcionTexto = this.props.contactoContenido.descripcion
        .descripcionContacto;
      if (this.props.lengua === "ga") {
        descripcionTexto = this.props.contactoContenido.descripcion
          .descripcionContactoGalego
          ? this.props.contactoContenido.descripcion.descripcionContactoGalego
          : this.props.contactoContenido.descripcion.descripcionContacto;
      }
    }
    ...
    return (
      <div>
        <div
          ...
          style={{ textAlign: "center", marginBottom: "15px", float: "right" }}
        >
        ...
        <div className="col-xs-12 col-sm-12 col-md-4 col-lg-4 text-center">
          ...
          <div>
            <a href={"mailto:" + contactoLinks.contactMail}>
              {contactoLinks.contactMail}
            </a>
            <hr
              style={{
                padding: 0,
          ...
          {contactoLinks.contactPhone !== "no" && (
            <div>
              <a href={"tel:" + contactoLinks.contactPhone}>
                {contactoLinks.contactPhone}
              </a>
              <hr
                style={{
                  padding: 0,
