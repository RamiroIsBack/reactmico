...
export default class Feria extends React.Component {
  ...
  render() {
    ...
    if (this.props.lengua === "ga") {
      direccion = this.props.feria.direccionGalego
        ? this.props.feria.direccionGalego
        : this.props.feria.direccion;
      descripcion = this.props.feria.descripcionGalego
        ? this.props.feria.descripcionGalego
        : this.props.feria.descripcion;
    }
    return (
      <div>
        <div className="row" style={{ paddingLeft: "5px" }}>
          ...
          >
            <h4
              ...
              style={{ whiteSpace: "initial", paddingLeft: 4 }}
            >
        ...
        <div className="row" style={{ marginTop: "10px" }}>
          ...
          <div>
            {this.props.screenSize === "mobile" && (
              <div>
                {!this.state.mostrarMas && (
                  <div>
                    <div
                      className=" col-xs-11 col-sm-5 col-md-5 col-lg-5"
                      style={{
                        textAlign: "left",
                        padding: 0,
                        paddingLeft: "10px",
                    ...
                    <div
                      className="col-xs-11 glyphicon glyphicon-chevron-down text-center"
                      onClick={() => {
                        this.setState({ mostrarMas: !this.state.mostrarMas });
                      }}
                    />
                  </div>
                )}
                {this.state.mostrarMas && (
                  <div>
                    ...
                    <div
                      className="col-xs-11 glyphicon glyphicon-chevron-up text-center"
                      onClick={() => {
                        this.setState({ mostrarMas: !this.state.mostrarMas });
                      }}
                    />
            ...
            {this.props.screenSize === "laptop" && (
              <div
                className=" col-xs-11 col-sm-5 col-md-5 col-lg-5"
                style={{ textAlign: "left", padding: 0, paddingLeft: "10px" }}
              >
                {descripcion.split("\n").map((item, key) => {
                  return (
                    <span key={key}>
