  ...
  render(){
    ...
    return (
      ...
      <div style={estiloModal} onMouseLeave={this.handleHoverOff.bind(this)}>
        ...
        <div className= 'col-xs-7 col-sm-7 col-md-7 col-lg-7 ' style ={{padding:1}} >
          <a className= 'pull-right' id='entrar'  onClick = {this.gestionaLogin.bind(this)}  style ={{color:'rgba(0,0,0,0.45)',cursor: 'pointer',textDecoration: 'none',}}>
            tengo cuenta
          </a>
        </div>
        <div className= 'col-xs-5 col-sm-5 col-md-5 col-lg-5'  style ={{padding:1, paddingLeft :5}} >
          <a id='entrar'  onClick = {this.gestionaLogin.bind(this)}  style ={{color:'black',cursor: 'pointer',textDecoration: 'none',}}>
            Entrar
          </a>
        </div>
        ...
        <div className= 'col-xs-7 col-sm-7 col-md-7 col-lg-7 ' style ={{padding:1}} >
          <a className= 'pull-right' id='registrarse'  onClick = {this.gestionaLogin.bind(this)}  style ={{color:'rgba(0,0,0,0.45)',cursor: 'pointer',textDecoration: 'none',}}>
            soy nuevo aqui
          </a>
        </div>
        <div className= 'col-xs-5 col-sm-5 col-md-5 col-lg-5'  style ={{padding:1,paddingLeft :5}} >
          <a className ='' id='registrarse'  onClick = {this.gestionaLogin.bind(this)}  style ={{width :' 90%', color:'black',cursor: 'pointer',textDecoration: 'none',}}>
            Registrarse
          </a>
        </div>
...
//                                   ****
export default connect (stateToProps,dispatchToProps)(ModalLoginContainer)
