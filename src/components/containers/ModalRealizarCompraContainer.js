...
class ModalRealizarCompraContainer extends Component {
  ...
  guardarDatosPedido(data) {
    ...
    let paypalEnvio = {
      calle:
        data.paypalAddress.line1 +
        " " +
        (data.paypalAddress.line2 !== undefined
          ? data.paypalAddress.line2
          : ""),
...
const dispatchToProps = dispatch => {
  return {
    ...
    guardarDatosPedido: (datosEnvio, carro, paymentData) =>
      dispatch(actions.guardarDatosPedido(datosEnvio, carro, paymentData)),
